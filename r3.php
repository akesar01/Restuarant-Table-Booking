...
where t.userid= '$e'
and t.restid = 3 and t.rdate='$Date';";
...
<form  method="POST">
  ...
  <div>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <label style="color:white;font-size: 30px;">Stories </label>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <br>
    ...
    <div>
      ...
      <br>
      <br>
      <small ><small style="text-align: right;">Timings : 12pm to 11 pm</small> </small>
    </div>
    <br>
