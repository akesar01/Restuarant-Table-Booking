...
where t.userid= '$e'
and t.restid = 5 and t.rdate='$Date';";
...
<form  method="POST">
  ...
  <div>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <label style="color:white;font-size: 30px;">The Permit Room </label>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <br>
    ...
    <div>
      ...
      <br>
      <br>
      <small ><small style="text-align: right;">Timings : 8am to 9 pm</small> </small>
    </div>
    <br>
