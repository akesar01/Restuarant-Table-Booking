...
where t.userid= '$e'
and t.restid = 7 and t.rdate='$Date';";
...
<form  method="POST">
  ...
  <div>
    &nbsp;&nbsp;&nbsp;&nbsp;
      <label style="color:white;font-size: 30px;">The Barbecue Kingdom </label>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  ...
  <br>
    ...
    <div>
      ...
      <br>
      <br>
      <small ><small style="text-align: right;">Timings : 1pm to 9 pm</small> </small>
    </div>
    <br>
