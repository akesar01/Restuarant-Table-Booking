...
where t.userid= '$e'
and t.restid = 2 and t.rdate='$Date';";
...
<form  method="POST">
	...
	<div>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	    <label style="color:white;font-size: 30px;">Empire Restaurant</label>
	    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div>
       ...
       name="Time" class="b2" placeholder="h:mm am||pm"
    	...
    	<br>
    	<br>
    	<small ><small style="text-align: right;">Timings : 9am to 12am</small> </small>
    </div>
    <br>
